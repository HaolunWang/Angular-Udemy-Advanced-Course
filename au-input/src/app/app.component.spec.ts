...
describe('AppComponent', () => {
    ...
    beforeEach(async(() => {
        ...
        fixture.detectChanges();// if changes that we make on test, we should give it detection change cycle so these changes get reflected in tho DOM
    }));
    ...
    it('should include the correct email icon inside the email input', async(() => {
        ...
        console.log(emailField.nativeElement.outerHTML);// to observe which html code is wrong
